  ...
  <body class="flex justify-center items-center min-h-screen max-[767px]:mx-[2rem]">
    ...
    >
      ...
      <div class="form bg-[#535556] content-center p-4 rounded w-full md:w-[30rem] md:h-[17rem]">
        ...
        <form @submit="handleSubmit" class="flex flex-col items-center md:relative w-full">
          <div class="flex flex-col w-full relative">
            <input
              ...
              class="my-2 mb-6 p-2 w-full rounded bg-[#323232] text-white pr-12"
            ...
            <div class="relative">
              <input
                ...
                class="p-2 w-full rounded bg-[#323232] text-white pr-12"
        ...
        <a href="#" id="forgot-password" class="font-medium block text-center md:text-left mt-6"
...
.error-message {
  height: 1.5rem; /* Define a fixed height to avoid changing the layout */
}
</style>
